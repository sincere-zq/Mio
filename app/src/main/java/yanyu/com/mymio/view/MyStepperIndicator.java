...
public class MyStepperIndicator extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 默认值
        int defaultCircleColor = ContextCompat.getColor(context, R.color.shade);
        float defaultCircleRadius = resources.getDimension(R.dimen.dp_10);
        float defaultCircleStrokeWidth = resources.getDimension(R.dimen.dp_01);

        int defaultIndicatorColor = ContextCompat.getColor(context, R.color.shade);
        float defaultIndicatorRadius = resources.getDimension(R.dimen.dp_07);

        float defaultLineStrokeWidth = resources.getDimension(R.dimen.dp_04);
        float defaultLineMargin = resources.getDimension(R.dimen.dp_03);
        int defaultLineColor = ContextCompat.getColor(context, R.color.shade);
        int defaultLineDoneColor = ContextCompat.getColor(context, R.color.black);
        ...
        isCirclePaint = new Paint();
        isCirclePaint.setStrokeWidth(a.getDimension(R.styleable.StepperIndicator_stpi_circleStrokeWidth, defaultCircleStrokeWidth));
        isCirclePaint.setStyle(Paint.Style.STROKE);
        isCirclePaint.setColor(a.getColor(R.styleable.StepperIndicator_stpi_circleColor, defaultLineDoneColor));
        isCirclePaint.setAntiAlias(true);
        ...
        isIndicatorPaint = new Paint(circlePaint);
        isIndicatorPaint.setStyle(Paint.Style.FILL);
        isIndicatorPaint.setColor(a.getColor(R.styleable.StepperIndicator_stpi_indicatorColor, defaultLineDoneColor));
        isIndicatorPaint.setAntiAlias(true);
...
//        doneIcon = zoomImg(BitmapFactory.decodeResource(resources, R.mipmap.dingdandian1), circleRadius * 2 + defaultCircleStrokeWidth, circleRadius * 2 + defaultCircleStrokeWidth);
...
//                canvas.drawCircle(indicator, centerY, radius, indicatorPaint);
                if (!isInEditMode()) {
                    if ((i != previousStep && i != currentStep) || (!inCheckAnimation && !(i == currentStep && !inAnimation))) {
                        canvas.drawCircle(indicator, centerY, circleRadius, isCirclePaint);
                        canvas.drawCircle(indicator, centerY, animIndicatorRadius, isIndicatorPaint);
                    }
//                        canvas.drawBitmap(doneIcon, indicator - (doneIcon.getWidth() / 2), centerY - (doneIcon.getHeight() / 2), null);
//                        canvas.drawBitmap(doneIcon, indicator , centerY, null);
                }
            }
