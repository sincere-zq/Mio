 ...
 */
public class CustomVerticalScollView extends ScrollView {
    private int downX, x;
    private int downY, y;
    ...
    public CustomVerticalScollView(Context context) {
        super(context);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public CustomVerticalScollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
    }

    public CustomVerticalScollView(Context context, AttributeSet attrs, int defStyleAttr) {
